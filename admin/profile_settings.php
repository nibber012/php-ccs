...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            $query = "UPDATE admins 
                     ...
                     WHERE user_id = ?";
            $stmt = $conn->prepare($query);
            $stmt->execute([$first_name, $last_name, $department, $user['id']]);
    ...
    // Get admin details
    $query = "SELECT department FROM admins WHERE user_id = ?";
    $stmt = $conn->prepare($query);
    $stmt->execute([$user['id']]);
                    ...
                    <form method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="department" 
                                   value="<?php echo htmlspecialchars($admin['department']); ?>" required>
                        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">Department: <?php echo htmlspecialchars($admin['department']); ?></p>
                </div>
            </div>
        </div>
    </div>
